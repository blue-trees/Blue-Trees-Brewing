          ...
          <div class="col-lg-12">
            ...
            <form method="post">
                <div class="container">
                      ...
                      <div  class="form-group">
                        <p class="mt-4">If you don't have your account, please make sure to register your informaton <span><a href="register.php" class="font-weight-bold font-bottom-kine" style="border-bottom: solid 1px;"> here.</a></span></p>
                      </div>
                  </div>
            </form>
          </div>

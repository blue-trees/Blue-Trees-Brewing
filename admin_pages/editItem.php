...
if(isset($_POST["updateItem"])) {
    ...
    $item->updateItem($name,$price,$quantity,$item_id);
}
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 section-title text-center mb-3">
            <h2 class="d-block">Edit Item</h2>
          </div>
        </div>
        <form action="" method="post" class="w-50 mx-auto">
            <div class="form-group">
                <label for="">Item Name</label>
                <input type="text" name="name" class="form-control" value="<?php echo $get_item['item_name'];?> ">
            </div>
            <div class="form-group">
                <label for="">Item Price</label>
                <input type="text" name="price" class="form-control" value="<?php echo $get_item['item_price'];?> ">
            </div>
            <div class="form-group">
                <label for="">Item Quantity</label>
                <input type="text" name="quantity" class="form-control" value="<?php echo $get_item['item_quantity'];?> ">
            </div>
            <button type="submit" name="updateItem" class="btn btn-primary mt-3">Update Item</button>
        </form>
    </div>
    </div>
